                  ...
                  children: [
                    Expanded(
                      child: CustomButton(
                        width: 100,
                        onTap: () {
  print("Points before update: ${Provider.of<GameProvider>(context, listen: false).points}");
  Provider.of<GameProvider>(context, listen: false).points +=
      score;
  print("Points after update: ${Provider.of<GameProvider>(context, listen: false).points}");
